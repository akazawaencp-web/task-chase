    ...
    try:
        await asyncio.wait_for(
            asyncio.get_event_loop().run_in_executor(
                None, lambda: line_handler.reply_text(event, reply_msg)
            ),
            timeout=10,
        )
...
async def debug_network():
    ...
    import httpx
    results = {}
    for name, url in [("google", "https://www.google.com"), ("anthropic", "https://api.anthropic.com"), ("line", "https://api.line.me")]:
        try:
